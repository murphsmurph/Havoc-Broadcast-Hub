...
7. **Automations open PRs, never push to main** (EP refresh already does this — keep it; apply to anything new). Any fetch Action fails soft: keep last good file, never commit an empty file over a good one.
