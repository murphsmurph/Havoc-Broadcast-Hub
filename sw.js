...
const PRECACHE=['./','./index.html','./css/hub.css','./mobile.css','./js/logos.js','./js/reference.js','./js/career-math.js','./js/feeds.js','./js/booth.js','./js/boot.js','./js/daily-report-parser.js','./data/havoc_players.json','./data/matchups.json','./data/season2526_final.json'];
