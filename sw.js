...
const PRECACHE=['./','./index.html','./css/hub.css','./mobile.css','./js/career-math.js','./js/daily-report-parser.js','./data/havoc_players.json','./data/matchups.json','./data/season2526_final.json'];
